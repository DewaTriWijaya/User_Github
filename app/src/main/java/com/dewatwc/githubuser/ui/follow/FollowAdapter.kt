package com.dewatwc.githubuser.ui.follow
...
class FollowAdapter(private val listData: ArrayList<DataUsers>): RecyclerView.Adapter<FollowAdapter.FollowHolder>() {
    ...
    override fun onBindViewHolder(holder: FollowHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            moveWithObjectIntent.putExtra(DetailActivity.EXTRA_DATA,  data.username)
